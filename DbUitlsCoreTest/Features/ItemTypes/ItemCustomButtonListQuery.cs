...
//                // await Task.Delay(10);
//                foreach (var item in buttonsRaw)
//                {
//                    Console.WriteLine(item);
//                    //Console.WriteLine(item["RIGHTCODE"]);
//                    string rc = item.rightcode;
//                    string pc = item.pagetype;
...
//                    if (button.RIGHTCODE != null)
//                    {
//                        Console.WriteLine("--- has item right code ----");
//                        Console.WriteLine(button.RIGHTCODE);
//                    }
